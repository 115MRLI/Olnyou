 ...
 * @time 2018/5/10
 */
public class FrontFragment extends BaseFragment implements GankContract {
    ...
    protected void initView(LayoutInflater inflater) {
        ...
        presenter.getGankLeadingEnd(page);
    ...
    public void addAdapter(List<ResultsBean> resultsBeen) {
        ...
        adapter.setOnLoadListener(new GankAdapter.OnLoadListener() {
            ...
            public void onItmeClick(ResultsBean gank) {
                GankWebActivity.jumpHere(getActivity(),gank.getUrl(),"前端技术");
            }
        });
    }
    @Override
